...
const unsigned char rom[ROM_SIZE] = {
    ...
    // Program 7: ECHOBACK for PIC UART ($0000-$001F)
    0xF8, 0xE0, 0xB2, 0xB3, 0xF8, 0x00, 0xA2, 0xF8, // 0000
    0x01, 0xA3, 0x03, 0xFA, 0x01, 0x32, 0x0A, 0x02,
    0xA4, 0x03, 0xFA, 0x02, 0x32, 0x11, 0x84, 0x52, // 0010
    0x30, 0x0A, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff            
#endif
